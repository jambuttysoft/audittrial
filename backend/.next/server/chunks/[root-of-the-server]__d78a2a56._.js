...
async function POST(request, { params }) {
    try {
        ...
        // Find the document
        const document = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.findFirst({
            where: {
                id,
                userId
            }
        ...
        if (document.status === 'DIGITIZED') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Document already digitized'
            }, {
                status: 400,
                headers: {
                    'Access-Control-Allow-Origin': 'http://localhost:3000'
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.update({
            where: {
                id
            },
            data: {
        ...
        try {
            ...
            const fullPath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), document.filePath);
            if (!(0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["existsSync"])(fullPath)) {
                throw new Error('File not found on disk');
            }
            // Read file for processing
            const fileBuffer = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["readFile"])(fullPath);
      ...
      `;
            ...
            for(let attempt = 1; attempt <= maxRetries; attempt++){
                try {
                    ...
                    const isRetryable = apiError.message.includes('503') || apiError.message.includes('overloaded') || apiError.message.includes('Service Unavailable');
            ...
            const documentWithRelations = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.findUnique({
                where: {
                    id
                },
                include: {
            ...
            const updatedDocument = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.update({
                where: {
                    id
                },
                data: {
            ...
            const digitizedDocument = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].Digitized.create({
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d78a2a56._.js.map
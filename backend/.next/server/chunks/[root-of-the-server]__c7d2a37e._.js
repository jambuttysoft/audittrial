...
async function POST(request) {
    try {
        const { email, password, isOAuthUser = false, oauthProvider, oauthId } = await request.json();
        ...
        if (isOAuthUser && (!oauthProvider || !oauthId)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: 'OAuth provider and ID are required for OAuth login'
            }, {
                status: 400,
                headers: {
                    'Access-Control-Allow-Origin': 'http://localhost:3000'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c7d2a37e._.js.map
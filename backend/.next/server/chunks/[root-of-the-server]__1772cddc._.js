...
"[project]/.next-internal/server/app/api/digitized/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/digitized/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { companyId, userId, originalDocumentId, fileName, filePath, fileSize, mimeType, purchaseDate, vendorName, vendorAbn, vendorAddress, documentType, receiptNumber, paymentType, amountExclTax, taxAmount, totalAmount, expenseCategory, taxStatus } = body;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(digitizedDocument, {
            status: 201,
            headers: corsHeaders
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1772cddc._.js.map
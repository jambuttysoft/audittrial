...
"[project]/node_modules/xero-node/dist/gen/api/payrollNZApi.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const models_1 = __turbopack_context__.r("[project]/node_modules/xero-node/dist/gen/model/payroll-nz/models.js [app-route] (ecmascript)");
const models_2 = __turbopack_context__.r("[project]/node_modules/xero-node/dist/gen/model/payroll-nz/models.js [app-route] (ecmascript)");
let defaultBasePath = 'https://api.xero.com/payroll.xro/2.0';
// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================
var PayrollNzApiApiKeys;
(function(PayrollNzApiApiKeys) {})(PayrollNzApiApiKeys || (exports.PayrollNzApiApiKeys = PayrollNzApiApiKeys = {}));
class PayrollNzApi {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */ createEmployeeLeaveSetup(xeroTenantId, employeeID, employeeLeaveSetup, idempotencyKey, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
            const localVarPath = this.basePath + '/Employees/{EmployeeID}/leaveSetup'.replace('{' + 'EmployeeID' + '}', encodeURIComponent(String(employeeID)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            let localVarFormParams = {};
            // verify required parameter 'xeroTenantId' is not null or undefined
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */ createEmployeeOpeningBalances(xeroTenantId, employeeID, employeeOpeningBalance, idempotencyKey, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
            const localVarPath = this.basePath + '/Employees/{EmployeeID}/openingBalances'.replace('{' + 'EmployeeID' + '}', encodeURIComponent(String(employeeID)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            let localVarFormParams = {};
            // verify required parameter 'xeroTenantId' is not null or undefined
     ...
     * @param payRun
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */ createPayRun(xeroTenantId, payRun, idempotencyKey, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
     ...
     * @param benefit
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */ createSuperannuation(xeroTenantId, benefit, idempotencyKey, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
     ...
     * @param xeroTenantId Xero identifier for Tenant
     * @param employeeID Employee id for single object
     */ getEmployeePayTemplates(xeroTenantId, employeeID, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
     ...
     */ getPayRunCalendar(xeroTenantId, payrollCalendarID, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
            const localVarPath = this.basePath + '/PayRunCalendars/{PayrollCalendarID}'.replace('{' + 'PayrollCalendarID' + '}', encodeURIComponent(String(payrollCalendarID)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            let localVarFormParams = {};
            // verify required parameter 'xeroTenantId' is not null or undefined
     ...
     */ getStatutoryDeduction(xeroTenantId, id, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
            const localVarPath = this.basePath + '/StatutoryDeductions/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            let localVarFormParams = {};
            // verify required parameter 'xeroTenantId' is not null or undefined
     ...
     * @param xeroTenantId Xero identifier for Tenant
     * @param page Page number which specifies the set of records to retrieve. By default the number of the records per set is 100.
     */ getStatutoryDeductions(xeroTenantId, page, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
     ...
     */ getSuperannuation(xeroTenantId, superannuationID, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
            const localVarPath = this.basePath + '/Superannuations/{SuperannuationID}'.replace('{' + 'SuperannuationID' + '}', encodeURIComponent(String(superannuationID)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            let localVarFormParams = {};
            // verify required parameter 'xeroTenantId' is not null or undefined
     ...
     * @param xeroTenantId Xero identifier for Tenant
     * @param page Page number which specifies the set of records to retrieve. By default the number of the records per set is 100.
     */ getSuperannuations(xeroTenantId, page, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
            const localVarPath = this.basePath + '/Superannuations';
     ...
     * @param employeeTax
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */ updateEmployeeTax(xeroTenantId, employeeID, employeeTax, idempotencyKey, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
            const localVarPath = this.basePath + '/Employees/{EmployeeID}/Tax'.replace('{' + 'EmployeeID' + '}', encodeURIComponent(String(employeeID)));
     ...
     * @param paySlip
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */ updatePaySlipLineItems(xeroTenantId, paySlipID, paySlip, idempotencyKey, options = {
        headers: {}
    }) {
        return __awaiter(this, void 0, void 0, function*() {
            const localVarPath = this.basePath + '/PaySlips/{PaySlipID}'.replace('{' + 'PaySlipID' + '}', encodeURIComponent(String(paySlipID)));
...
exports.PayrollNzApi = PayrollNzApi; //# sourceMappingURL=payrollNZApi.js.map
}}),

};

//# sourceMappingURL=node_modules_xero-node_dist_gen_api_payrollNZApi_ddabdd64.js.map
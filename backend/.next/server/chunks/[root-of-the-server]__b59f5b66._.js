...
async function POST(request) {
    try {
        ...
        if (userType === 'BUSINESS' || company) {
            ...
            try {
                createdCompany = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].company.create({
                    data: {
                        name: companyName,
